...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier('/home/pi/proyectos/PRUEBA/Recognition/WITH_LIBRARIES_CV/FaceRecognition/HaarCascade/haarcascade_frontalface_default.xml')#Load haar classifier
